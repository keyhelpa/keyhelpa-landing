...
const StripeComponent = (props) => {
  ...
  const handleSubmit = async (event) => {
    ...
    await stripe
      .createSource(elements.getElement("cardNumber"))
      .then(async (res) => {
        console.log("------------>><<", res);
        if (res.error) {
  ...
  const renderCardNumber = (name, label, className, type = "text") => {
    ...
    return (
      <div>
        <div>
          <label htmlFor="cardNumber" style={{ color: Colors.billingText }}>
            {label}
          </label>
          <div
            style={{
  ...
  const renderCardExpiryElement = (name, label, className, type = "text") => {
    ...
    return (
      <div>
        <div>
          <label htmlFor="cardExpiry" style={{ color: Colors.billingText }}>
            {label}
          </label>
  ...
  const renderCardCvcElement = (name, label, className, type = "text") => {
    ...
    return (
      <div>
        <div>
          <label htmlFor="cardCvc" style={{ color: Colors.billingText }}>
            {label}
          </label>
          <div style={style.fieldStyle}>
            <CardCvcElement
