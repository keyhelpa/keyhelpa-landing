...
import { faBars, faCalendar, faCheckSquare, faComment, faEye, faPager, faTimes, faTrash, faUser } from '@fortawesome/free-solid-svg-icons'
...
class Stack extends React.Component {
    ...
    retrieveComments(data) {
        ...
        API.request(Routes.commentRetrieve, parameter, response => {
            this.setState({
                commentIsLoading: false
            })
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <b>
                            {
                                account && account.information && Common.getCompleteName(account.information)
                            }
                        </b>
                    </div>
                    <div>
        ...
        return (
            <div>
                ...
                <div style={{
                    ...
                    {
                        this.props.data && (this.props.data.deleted_at == null || this.props.data.deleted_at == "") && this.newComment()
                    }
                    {
                        commentIsLoading && (
                            <Skeleton height={50} />
