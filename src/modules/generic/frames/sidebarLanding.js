...
function Sidebar(props) {
  ...
  const navigate = (item) => {
    ...
    if (item.title.toLowerCase().includes('join') || item.title.toLowerCase().includes('login')) {
    ...
    return (
      <ul
        style={{
          ...
          paddingLeft: 0,
          paddingBottom: 0,
          backgroundColor: history.location.pathname.includes('agent') ? Colors.agentHeaderBackground : Colors.helpaHeaderBackground
        }}
      >
        {
