...
class Stack extends React.Component {
                ...
                onClick={() => {
                  if (oItem.action == "redirect") {
                    this.props.history.push(
                      oItem.route + item[oItem.route_params]
                    );
                  } else {
  ...
  renderIndex(item, index, hItem, hIndex) {
    switch (hItem.type.toLowerCase()) {
      case "text":
        return this.renderText(hItem, item[hItem.variable]);
      case "ratings":
        return this.renderRatings(item[hItem.variable]);
      case "toggle_button":
        return this.renderToggle(item, item[hItem.variable]);
      case "redirect":
        return this.renderRedirect(hItem, item);
      case "action":
        return this.renderActions(hItem, item);
      case "document":
        return this.renderDocument(hItem, item);
      case "modal":
        return this.renderModal(hItem, item);
    }
  }
