    ...
    renderContent(){
        return(
            <div>
                ...
                <ol type='1'>
                    <li><b>Basic information</b> - this is where you set the final job title or name of the position of the Helpa</li>
                    <li><b>Description</b> - you will describe the final job description of Helpa - i.e., brief explanation of the type of work that the Helpa will perform. You may also attach files like images or documents to support the job description.</li>
                    <li><b>Tasks & responsibilities</b> - you will list the final tasks and responsibilities a Helpa will actually perform in this job.</li>
                    <li><b>Schedule & locations</b> -  you will set the final designation of Helpa as to when and what time is his/her schedules including the instructions and the list of properties the Helpa need to visit or market.</li>
                    <li><b>Budget</b> - set the final deal of payment rate ,you , the Agent, and the Helpa have agreed.</li>
                    <li><b>Preview</b> - this is where you can preview how this contract will look like in the Helpa’s view or how this contract will appear to Helpa.</li>
                    ...
                    <p><b>Note</b>: Before sending the final job offer, make sure to review and check if all the information or content of the contract is all good and correct. If something is missed or wrong, you may click the “Back to Edit” button and correct the changes before sending your job offer to Helpa.</p>
                </ol>
