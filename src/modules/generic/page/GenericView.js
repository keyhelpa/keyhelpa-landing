...
class Stack extends React.Component {
  ...
  renderDetails(data) {
    return (
      <div>
        <span style={{ ...style.full, padding: 0 }}>
        ...
        >
          {data.account.information.first_name +
            " " +
            data.account.information.last_name}
        </span>

        <span style={{ ...style.full, color: Colors.gray, padding: 0 }}>
          <span style={{}}>
            <FontAwesomeIcon
              icon={faMapMarkerAlt}
  ...
  contractLeft(data) {
    return (
      ...
      >
        ...
        {this.renderRow({
          value:
            data.job.job_terms.hourly_rate * data.job.job_terms.hours_per_day,
  ...
  // Right
  contractRight(data) {
    let tasks = data.job.requirements
      ? JSON.parse(JSON.stringify(data.job.requirements)).task
      : null;
    return (
      <div
        style={{ ...style.full, borderLeft: "1px solid" + Colors.borderGray }}
      >
        {this.renderText(
          {
            title: "About the Job",
            content: () => {
              return <span>{data.job.description}</span>;
            },
          },
          true
        )}
                      ...
                      >
                        <span>
                          <p style={{ fontWeight: "bold" }}>
                            {data.job.requirements.experience.title}
                          </p>
                          <p>Experience in Real Estate Industry</p>
                        </span>
                        <span>
                          <p style={{ fontWeight: "bold" }}>
                            {data.job.requirements.cert.certifications.title}
                          </p>
                          <p>License</p>
                        </span>
                      </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span>
                          <p style={{ fontWeight: "bold" }}>
                            {
                              data.job.requirements.insurance.vaccine.vaccine
                                .title
                            }
                          </p>
        ...
        {this.renderText({
          ...
          content: () => {
            return <span>{data.job.summary}</span>;
          },
        })}
      </div>
    );
      ...
      this.props.asContract && (
        ...
        >
          ...
          >
            ...
            >
              {(this.props.asPreview || this.props.asContract) &&
                this.contractLeft(data)}
              {
