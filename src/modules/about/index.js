      ...
      content: () => {
        return (
          <div className="contentContainer">
            <p>
              KeyHelpa originated from the question of how to improve the
              profitability of real estate agencies given the high cost of
              labour and overhead expenses, employment regulations and the
              competitive nature of the real estate industry.
            </p>
            <p>
              ...
              flexibility and versatility to deal with their high-volume
              activities without the need to undertake expensive employment and
              recruitment expenses. It allows experienced real estate personnel
              the flexibility to choose their working times to suit their own
          ...
          >
            ...
            <div className="imageContainer">
              <img
                src={
                  accountType === "agent"
                    ? require("assets/man-gray.png")
                    : require("assets/man-pink.png")
                }
