  ...
  renderBody(item) {
    return (
      ...
      >
        ...
        {item.account &&
          item.account.account_type === "Freelancer" &&
          item.account.experience && (
            <span
              style={{
                color: Colors.rgbaGray,
                width: "100%",
            ...
            >
              {HelperGeneric.getFirstLetterCapitalize(
                item.account.experience.title
              )}
            </span>
          )}
        {item.account &&
          item.account.account_type === "Agent" &&
          item.job &&
          item.job.categories && (
            <span
              style={{
    ...
    return (
      ...
      >
        ...
        {data.length === 0 && !isLoading && (
          <Empty message="You have no messages as of the moment." />
        )}
        {data.length > 0 &&
          data.map((item, ndx) => {
            return (
              <div
                ...
                onClick={() => {
                  ...
                  console.log(
                    this.props.state.subscribedToken,
                    "KEYHELPA-" + this.props.state.user.id
                  );
                  subscibe(
                    this.props.state.subscribedToken,
                    "KEYHELPA-" + this.props.state.user.id
