        ...
        >
          ...
          >
            <div style={{ marginBottom: '40px' }}>
              <iframe src={this.props.qrCode} height="300" width="300" scrolling="no" allowtransparency="true" style={{background: 'inherit'}}></iframe>
            ...
            <p style={{
              paddingTop: 40
            }}>Enter code generated by your authenticator app</p>
          </div>
        </div>
      </Modal.Body>
          ...
          bottomComponent={() => {
            return (
              <p>You can
                ...
                </b> to your phone from App or Google Play Store.</p>
            )
          }}
        />
      </Modal>
