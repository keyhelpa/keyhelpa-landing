...
class Billing extends React.Component {
      ...
      >
        ...
        >
          ...
          <div>
            <p>
              <b>Account Number:</b>{" "}
              {"*********" + paymentMethod.details.details.source.card.last4}
            </p>
            <p>
              <b>Expiry Date:</b>{" "}
              {paymentMethod.details.details.source.card.exp_month +
                "/" +
                paymentMethod.details.details.source.card.exp_year}
            </p>
          </div>
  ...
  renderLeft() {
    ...
    return (
      ...
      >
        <Elements
          stripe={loadStripe(`${REACT_APP_STRIPE_PK}`)}
  ...
  renderRight() {
    ...
    return (
      ...
      >
        <span>
          <p>
            Please provide your online banking details KeyHelpa uses Stripe for
      ...
      >
        ...
        {this.props.agent && this.props.agent === true && (
          <div style={{ width: "100%" }}>
            ...
            >
              <b>Payment logic:</b> Your credit card will be deducted for the
              amount equal to a 1-week payment, until the job contract is
              completed or cancelled.
              <br />
              <br />
              <b>Payments day:</b> On Monday of each week for the duration of
              the term of the contract the freelancer submits a payment request.
              The payment is equal to "weekly payment''. Payer receives a
              notification email of payment due. The payer is not required to
              take any action unless he/she declines the payment by clicking the
              decline link.
              <br />
              <br />
              <b>Decline payment:</b> Payer is required to provide reasons for
              the cancellation of the contract and for declining payment. A
              notification is sent to the freelancer for their reply. The
              payment held in Stripe is held in Keyhelpa's disputed account
              until the dispute is settled within the terms and conditions.
            </p>
          </div>
        )}
        <Confirmation
