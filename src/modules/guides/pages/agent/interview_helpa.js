    ...
    renderContent() {
        return (
            <div>
                ...
                <ul >
                    <li><b>Job</b> - this is not editable since it is retrieved from the job the Helpa has sent a proposal.</li>
                    <li><b>Message to candidate</b> - send the Helpa a message of the full instructions of this job interview including the link of the medium you will use for discussion either audio call or video call.</li>
                    <li><b>Interview Date</b> - set the date when you will conduct the interview.</li>
                    <li><b>Interview Time</b> - set the time when you will conduct the interview.</li>
                </ul>
