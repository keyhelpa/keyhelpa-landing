...
class CreateAccountHelpa extends Component {
  ...
  renderContent() {
    return (
      ...
      >
        <p>
          Follow the steps below to register as Helpa (Freelancer) in KeyHelpa:
        </p>
        <ol type="1">
          <li>
            Go to the Helpa Sign Up Page (Click{" "}
            <a href={`${REACT_APP_HELPA}/signup`}>here</a>).
          </li>
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          Are you into the Real Estate Industry? If yes, get any freelance jobs
