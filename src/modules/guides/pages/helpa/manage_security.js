    ...
    renderContent(){
        return(
            <div style={{
                ...
                <ol type='1'>
                    <li>On Helpa’s web application, click your profile icon or photo then a dropdown menu will appear. Choose “Settings” and you will be taken to a new sidebar menu. Click the “Security” on your sidebar menu and you will be redirected to the “Two-step verification” page.</li>
                    <li>On your “Two-step verification” page, you can add the following extra layer of protections:</li>
                    <ul>
                        <li><b className='b-helpa'>Text message</b> - You will receive a six digit code by text message to confirm it's you when you sign in to your KeyHelpa account.</li>
                        <li><b className='b-helpa'>Google Authenticator</b> - You will enter a code generated by your authenticator app to confirm it's you when you sign in to your KeyHelpa account.</li>
                        <li><b className='b-helpa'>Security question</b> - You will answer a question you choose to confirm it's you when you sign in to your KeyHelpa account.</li>
                    </ul>
        ...
        return (
            <div style={{
                ...
                <p style={{
                    ...
                    Security is very important within KeyHelpa, this is why we add a two-step verification on our platform for all our users' accounts. Add an extra layer of security, now, to block unauthorised access and to have an additional protection for your account.
                </p>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(ManageSecurityHelpa));