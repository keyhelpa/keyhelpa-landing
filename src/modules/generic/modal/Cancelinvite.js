...
class Stack extends React.Component {
  ...
  updateProposal(reason, message) {
    ...
    API.request(
      ...
      {
        id: candidate.proposal ? candidate.proposal.id : candidate.id,
        account_id: user.id,
        freelancer: candidate.freelancer ? candidate.freelancer : candidate.id,
        merchant_id: user.merchant.id,
        category: "invite",
        job_id: data.id,
        category_status: "declined",
        amount: data.job_terms.hourly_rate,
        currency: data.job_terms.currency,
        status: "cancel",
        type: "proposals",
        to: candidate.freelancer ? candidate.freelancer : candidate.id,
