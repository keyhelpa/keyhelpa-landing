...
class Stack extends React.Component {
    ...
    submit() {
        ...
        if (user == null) return
        if (name == null || name == '' || location == null || location == '' || description == null || description == '') {
            this.setState({
        ...
        API.request(Routes.eventsCreate, parameter, response => {
            this.setState({
                isLoading: false
            })
    ...
    body() {
        const { name, nameError, location, locationError, description, descriptionError } = this.state;
