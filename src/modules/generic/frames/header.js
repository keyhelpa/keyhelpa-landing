...
const Header = (props) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <ProfilePicture size={50} iconSize={"lg"} data={user?.profile} />
          </div>
      ...
      >
        ...
        >
          <TextInput
            placeholder={
              "Search for " +
              (Helper.ACCOUNT_TYPE === "Agent" ? "candidates" : "jobs")
            }
            type={"text"}
            style={{
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div style={{}}>
            {user &&
              user.status.toLowerCase() === "account_verified" &&
              message()}
            {user &&
              user.status.toLowerCase() === "account_verified" &&
              notification()}
  ...
  return (
    <div
      ...
      expand="lg"
      className="justify-content-between padding-lr-50"
    >
      <div
        style={{
          float: "left",
