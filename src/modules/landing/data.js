        ...
        },
        {
            payload_value: {
                others: {
                    ...
                    description: "Quickly and easily access a pool of available freelancers who are familiar with the real estate and property management industry, the suburbs where you need work done and the job that needs doing.  Search profiles for a freelancer, or browse by skills, years of experience, area, service and more. Then select the type of help and price that’s right for you and your agency. No more full-time wages that you don’t need to pay - and more money saved.",
                    url: "/storage/image/2_2022-07-06_06_00_37_shakehand.png"
                }
            }
        },
        {
            payload_value: {
                others: {
                    ...
                    description: "Send instant messages to the person you choose as your Helpa. Once a job has been offered and accepted, you can automatically privately message one another so you’re in constant contact throughout. You’re in total control to communicate as and when you need to.",
                    url: "/storage/image/2_2022-07-06_06_01_13_hand_hold mobile.png"
                }
            }
        },
        {
            payload_value: {
                others: {
                    ...
                    url: "/storage/image/2_2022-07-06_06_01_34_hand_hold money.png"
                }
            }
        }
    ]
        ...
        },
        {
            payload_value: {
                others: {
                    title: "Total control. Constant contact.",
                    description: "Send instant messages to the person you choose as your Helpa. Once a job has been offered and accepted, you can automatically privately message one another so you’re in constant contact throughout. You’re in total control to communicate as and when you need to.",
                    url: "/storage/image/2_2022-07-06_06_06_20_hand_hold money pink.png"
                }
            }
        },
        {
