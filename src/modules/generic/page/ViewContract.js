...
class Stack extends React.Component {
  ...
  submit(params) {
    ...
    API.request(
      data.status === "active"
        ? Routes.contractActionCreate
        : Routes.contractActionUpdate,
      parameter,
      (response) => {
      ...
      <ContractModal
        ...
        onClick={(data) => {
          this.submit({
            ...data,
            status:
              Helper.ACCOUNT_TYPE == "Agent" ? "dispute" : "dispute_pending",
            action: "dispute",
          });
        }}
        onCancel={() => {
  ...
  renderPause() {
    ...
    return (
      <ContractModal
        ...
        onCancel={() => {
          this.hideModal(
            Helper.ACCOUNT_TYPE == "Agent" ? "pause" : "pause_pending"
          );
        }}
      />
    );
    ...
    return (
      <IconTextModal
        ...
        description={() => {
          return (
            <div>
              <p>General tips to terminate your contract:</p>
              ...
              >
                ...
                >
                  If you cancel a job 3 times within month, your profile will be
  ...
  renderEndThird() {
    ...
    return (
      <IconTextModal
        ...
        description={
          "The contract was terminated. Thanks for your work. We wish you good luck with your search."
        }
        onClick={(selected) => {
        ...
        description={() => {
          return (
            <div>
              ...
              >
                Your request has successfully raised to the agent. Please stay
                posted.
              </p>
            </div>
          );
        ...
        description={() => {
          return (
            <div>
              ...
              >
                You have made three attempts to close the contact. Your profile
                has been blocked.
                <b
                  style={{
                    color: Colors.primary,
  ...
  render() {
    ...
    const { endModalSecond, endModalThird, reachAttempModal, pausePending } =
      this.state;
    return (
      <div
        style={{
