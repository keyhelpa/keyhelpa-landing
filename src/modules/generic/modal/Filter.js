...
class Stack extends React.Component {
  constructor(props) {
    ...
    this.state = {
      title: 'Filter jobs',
      subTitle: 'Set your preferred job details to get matches relevant to your desired work.',
      categories: [],
      filter: null,
      states: []
    };
  ...
  async componentDidMount() {
    if (Helper.ACCOUNT_TYPE == 'Agent') {
      this.setState({
        ...
        subTitle: 'Set your preferred details to get matches relevant to your desired candidate for the job.'
      })
  ...
  retrieveCategories() {
    ...
    API.request(Routes.categoriesRetrieve, {
      sort: {
        name: 'asc'
      }
    }, response => {
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          {
            categories && categories.length > 0 && this.renderCheckbox('Categories', categories, 'categories')
          }
        </div>
        ...
        <div style={{
          ...
          >
            {
              this.renderCheckbox('Hourly rate', HelperString.hourlyRate, 'hourly_rate')
            }
            {
              this.renderCheckbox('Experience', HelperString.experience, 'experience')
            }
            {
              this.renderCheckbox('Cetification', HelperString.certification, 'certification')
            }
          </div>
          <div style={{
            float: 'left',
            ...
            className="full-width-mobile">
            {
              this.renderCheckbox('Vaccination', HelperString.vaccination, 'vaccination')
            }
          </div>
