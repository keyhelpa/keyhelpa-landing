...
class Stack extends React.Component {
  ...
  submit() {
    ...
    API.request(Routes.accountRequestChangePass, { username }, response => {
  ...
  render() {
    const { username, errorUsername, isLoading, sendFlag, errorMessage } = this.state;
    return (
            ...
            sendFlag && (
              <span>
                <p style={{
                  ...
                  If the email address <b><i>{username}</i></b> exists in our system, we sent an email with a link to reset the password.
                </p>
                <p style={{
                  textAlign: 'center'
                }}>
                  If you don't see our email, check your spam folder, or <b>contact support</b> for more help.
                </p>
