    ...
    renderContent(){
        return(
            <div>
                ...
                <p>Meanwhile,  there are opportunities when you  don’t have to hunt for a freelance job because the Agent will hunt you by inviting you to send a job proposal via job invitation. You will receive a job invitation via email notification which will eventually lead you to view the job invitation details or you may check on your “My proposals” page under <b>Pending</b> Invite Section, just click the “View” on the action column to view the job invitation details page. On the “Job details'' page, read the full details of the job and if you think that you are fit for the job and want to accept job invitation,  then click on the “Accept Invite” button on the upper right corner of the page and then  a “Submit proposal” modal will pop up. Then, follow step 4 from the instructions above.</p>
                <p>All submitted job proposals can be seen on your “My proposals” page. Job proposals sent via job invitation can be found in the <b>Accepted</b> Invites Section while those proposals that have been sent not via job invitation can found in the <b>Pending</b> Proposals Section.</p>
