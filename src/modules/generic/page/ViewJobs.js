...
class Stack extends React.Component {
  ...
  header(data) {
    let address = data.region === undefined ? data.job_terms.region : data.region
    return (
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            {
              data.proposal != null && (data.proposal.category != 'invite' || (data.proposal.category === 'invite' && data.proposal.category_status !== 'pending')) && (
                <Button
                  title={'Message agent'}
                  onClick={() => {
            ...
            {
              data.proposal != null && (data.proposal.category == 'invite' && data.proposal.category_status === 'pending') && (
                <Button
                  title={'Accept Invite'}
                  onClick={() => {
                    if (this.props.payload && this.props.payload == 'preview') {
