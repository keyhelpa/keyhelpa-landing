        ...
        >
          <CircularProgressbar
            ...
            styles={buildStyles({
              ...
              trailColor:
                user.account_type === "Freelancer" ? "#FEF2f7" : "#8e9cad", // all circle
          ...
          >
            ...
            >
              <path
                ...
                fill="url(#paint0_linear_882_9254)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_882_9254"
                  x1="-25.6449"
                  y1="-18.7048"
                  x2="-25.6449"
                  y2="28.4624"
                ...
                >
                  <stop
                    stop-color={
                      user.account_type === "Freelancer" ? "#E62D7E" : "#34475D"
                    }
                  />
                  <stop
                    offset="1"
                    stop-color={
                      user.account_type === "Freelancer" ? "white" : "#F1F5FB"
                    }
                  />
                </linearGradient>
              </defs>
