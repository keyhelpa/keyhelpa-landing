    ...
    return (
      ...
      >
        <Pagination size="lg">
          ...
          {this.props.prev && <Pagination.Prev onClick={() => this.onPrev()} />}
          ...
          {[-2, -1, 0, 1, 2].map((item) => (
            ...
            >
              {this.props.offset && this.props.offset > 2
                ? this.props.offset + item
                : item + 3}
            </Pagination.Item>
          ))}
          {this.props.next && <Pagination.Next onClick={() => this.onNext()} />}
