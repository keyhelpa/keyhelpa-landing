    ...
    return (
      ...
      >
        <p>
          ...
          the following guidelines for Helpa to dispute a contract:
        </p>
        <ol type="1">
          <li>
          ...
          <ul>
            ...
            <li>
              ...
              “View” on the action column of the job contract and you will be
              redirected to the “Contract Details” page where you can see three
              buttons at the upper right corner of the page. Click the “Dispute”
              button, then an “Open dispute” confirmation modal will pop up.
            </li>
            ...
            <li>
              ...
              Agent is not yet confirmed to accept the termination of this
              contract.{" "}
            </li>
            <p>
              This unconfirmed end contract status can be disputed when you
              click the “View” on the action column of the job contract and you
          ...
          <p>
            Once you open a dispute to the contract, the Agent will receive an
          ...
          <li>
            ...
            if the Agent does not yet take action of the dispute contract
            ...
            the dispute of contract (by Accept button) , it means the Helpa and
            Agent can still settle their issues within KeyHelpa’s platform
            inline with the terms and conditions set by KeyHelpa. Unless, if the
            Agent declines to open disputes with the contract, that is another
            process where the Helpa can ask for consultation with KeyHelpa by
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(DisputeContractHelpa));
